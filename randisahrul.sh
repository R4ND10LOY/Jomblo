...
echo -e $bu  "Gunakan tols dengan bijak :)  "
...
sleep 1
echo -e $g"       ||||||PAKAI AJA ASAL JANGAN DI RECODE;)|||||"
sleep 2
...
echo -e $g "   [19] Install metasploit";
echo -e $g "   [20] Tembak Cewe(khusus jones )";
echo -e $g "   [21] TUTORIAL SINGKAT;V" ;
echo -e $g "   [ 0] BUSIAT/Exit";
echo ""
echo -e $bu "Pilih Sesuai Keinginan:)" 
echo -e $bu "Subscribe To Channel RANDI OLOYY==> otomatis Gagal <==[        ga subskreb auto mandul kere boss:v]"
read -p "====>" pil  ;
...
git clone https://github.com/R4ND10LOY/MetasINS.git
cd MetasINS
./MetasploitInstall
